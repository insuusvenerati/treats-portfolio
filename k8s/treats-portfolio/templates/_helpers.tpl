...
*/}}
{{- define "treats-portfolio.fullname" -}}
...
Common labels
*/}}
{{- define "treats-portfolio.labels" -}}
helm.sh/chart: {{ include "treats-portfolio.chart" . }}
